...
//========================================================================================
    ...
    @Test
    public void handleCheckedExceptions() throws GetOutOfHereException {
    ...
    Flux<User> capitalizeMany(Flux<User> flux) throws GetOutOfHereException {
    ...
    private class GetOutOfHereException extends RuntimeException {
    }
