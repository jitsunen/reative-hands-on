...
//========================================================================================
    ...
    void expectSkylerJesseComplete(Flux<User> flux) {
        StepVerifier.create(flux).expectNextMatches((u) -> u.getUsername().equals("swhite")).expectNextMatches((u) -> u.getUsername().equals("jpinkman")).verifyComplete();
    }
...
//========================================================================================
    ...
    public void countWithVirtualTime() {
        expect3600Elements(() -> Flux.interval(Duration.ofMillis(1)).take(3600));
    }
    ...
    void expect3600Elements(Supplier<Flux<Long>> supplier) { StepVerifier.create(supplier.get()).expectNextCount(3600).verifyComplete();
    }
