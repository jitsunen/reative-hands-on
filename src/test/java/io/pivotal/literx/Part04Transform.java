...
//========================================================================================
    ...
    Mono<User> capitalizeOne(Mono<User> mono) {
        Function<User, User> userUserFunction = upperCaseUserFunction();
        return mono.map(userUserFunction);
    }

    private Function<User, User> upperCaseUserFunction() {
...
//========================================================================================
    ...
    Flux<User> capitalizeMany(Flux<User> flux) {
        return flux.map(upperCaseUserFunction());
    }
